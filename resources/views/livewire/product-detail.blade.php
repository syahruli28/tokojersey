                ...
                <div class="col">
                    <form wire:submit.prevent="masukkanKeranjang">
                        <table class="table" style="border-top: hidden">
                            ...
                            {{-- tampilkan nameset form jika jumlah kurang dari 2 atau jumlah = 1 --}}
                            @if ($jumlah_pesanan > 1)
                            @else
                                <tr>
                            ...
                            <tr>
                                <td colspan="3">
                                    <button type="submit" class="btn btn-dark btn-block" @if($product->is_ready !== 1) disabled @endif ><i class="fas fa-shopping-cart"></i> Masukan ke keranjang</button>
                                </td>
                            </tr>
                        </table>
                    </form>
